...
TEAMS = {
    "fc barcelona": {"name": "Barcelona", "slug": "fc-barcelona", "id": "131"},
    "real madrid": {"name": "Real Madrid", "slug": "real-madrid", "id": "418"},
    "manchester united": {"name": "Man United", "slug": "manchester-united", "id": "985"},
    "atletico madrid": {"name": "Atlético Madrid", "slug": "atletico-madrid", "id": "13"},
    "manchester city": {"name": "Man City", "slug": "manchester-city", "id": "281"},
    "chelsea": {"name": "Chelsea", "slug": "chelsea", "id": "631"},
    "borussia dortmund": {"name": "Dortmund", "slug": "borussia-dortmund", "id": "16"},
